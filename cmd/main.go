...
import (
	"github.com/egor-lukin/external-proxy/internal"
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		internal.RunProxy(duration, certsPath, nginxSettingsPath, kubeNamespace)
	},
}
...
func init() {
	...
	runCmd.Flags().StringVar(&kubeNamespace, "kubeNamespace", "default", "Kubernetes namespace")
